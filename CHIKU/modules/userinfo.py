...
from CHIKU.modules.alive import Mukesh
import CHIKU.modules.sql.userinfo_sql as sql
from CHIKU import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from CHIKU.__main__ import STATS, TOKEN, USER_INFO
from CHIKU.modules.disable import DisableAbleCommandHandler
from CHIKU.modules.helper_funcs.chat_status import sudo_plus
from CHIKU.modules.helper_funcs.extraction import extract_user
from CHIKU.modules.sql.global_bans_sql import is_user_gbanned
from CHIKU.modules.sql.users_sql import get_user_num_chats
            ...
            message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url=f"https://t.me/HEROKUFREECC"
                            ),
                            InlineKeyboardButton(
