...
from CHIKU.modules.nightmode import button_row
from CHIKU import BOT_USERNAME, OWNER_ID,BOT_NAME, SUPPORT_CHAT, telethn
from CHIKU.events import register
...
async def lego(event):
    ...
    try:
        ...
        fnt = glob.glob("./CHIKU/resources/fonts/*")
