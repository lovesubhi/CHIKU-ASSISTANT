...
# from CHIKU.modules.sql import warns_sql as warnssql
import CHIKU.modules.sql.blacklist_sql as blacklistsql

# from CHIKU.modules.sql import cust_filters_sql as filtersql
# import CHIKU.modules.sql.welcome_sql as welcsql
import CHIKU.modules.sql.locks_sql as locksql
import CHIKU.modules.sql.notes_sql as sql

# from CHIKU.modules.rules import get_rules
import CHIKU.modules.sql.rules_sql as rulessql
from CHIKU import EVENT_LOGS,OWNER_ID, SUPPORT_CHAT, dispatcher
from CHIKU.__main__ import DATA_IMPORT
from CHIKU.modules.connection import connected
from CHIKU.modules.helper_funcs.alternate import typing_action
from CHIKU.modules.helper_funcs.chat_status import user_admin
from CHIKU.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("CHIKU{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("CHIKU{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `CHIKU-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("CHIKU{}.backup".format(chat_id))  # Cleaning file
