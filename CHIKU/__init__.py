...
if ENV:
    ...
    from CHIKU.config import Development as Config
...
pbot = Client("CHIKU", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN,in_memory=True)
...
from CHIKU.modules.helper_funcs.handlers import (
